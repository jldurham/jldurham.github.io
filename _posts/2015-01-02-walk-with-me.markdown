...
Right now, in neighborhoods across the country, countless health practitioners are telling a patient that they need to be more active. This person could be of any age, race or gender, but the advice would be the same: try to include more activity in your daily life. Maybe go for a walk after dinner every night, they’re told. It’s a common problem experienced by many people living the sedentary lifestyle that accompanies a world full of laptops, Netflix, and 9-5 office shifts. The simple inclusion of 30 minutes of daily walking could dramatically alter a person’s physical and mental health, so a stroll around the neighborhood is an activity that’s importance should not be underestimated.
...
The site can be divided into two sections: the public area and the member area that can only be accessed through log-in. 

**The public area is simple and can be reduced to the following functions:**

* Searching for walking group
* Creating a walking group
...
**The member area of the site is more complex and includes the following functions:**

* Searching for a walking buddy (bulletin board interface)
* Searching for a walking buddy (additional search by interest/age/location/etc for meeting groups in same network)
* Managing a schedule (calendar interface)
* Journaling walks (text and photos) with personal, group or public visibility (diary interface)
* Offline meetings with walking groups
* News Feed for walking groups (centerpiece of individual walking group pages)
* Logging walking stats (time/distance/pace) and measurements (heart rate/weight)
* Contact list/history of walking buddies
* Messaging system 
* Mapping feature to log, share and print walking routes (for groups/network)
* Accessing health and fitness resources
* Managing a profile and settings
* Live tracking of walkers and ability to send them “cheer” message
...
There is a traditional navigation bar at the top of the screen in the header, where the user can access all of the main content areas of the site, as well as the profile and settings control area. The design of the site is intended to be as simple as possible, to accommodate novice users such as the elderly. The screens either change to new pages or there are smaller screen areas that appear as an overlay. Elements such as back and submit buttons are clear, and there is little dynamic content that might confuse users who need a simple and conventional layout to best accomplish their tasks.
